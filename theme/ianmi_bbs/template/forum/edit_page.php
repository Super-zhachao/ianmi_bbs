...
?>
  ...
  <form class="_edit_forum" action="/forum/save.json?token=<?= $user['uuid'] ?>&id=<?= $forum['id'] ?>" method="post">
    ...
    <div class="_edit_content" id="contentEditor" placeholder="说点啥好呢？"><?= $forum['context'] ?></div>
